...
export interface VRFv2ConsumerInterface extends utils.Interface {
  functions: {
    ...
    "s_randomValue()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "s_randomValue",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface VRFv2Consumer extends BaseContract {
  ...
  functions: {
    ...
    s_randomValue(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    s_randomValue(overrides?: CallOverrides): Promise<PopulatedTransaction>;
